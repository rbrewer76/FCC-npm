...
const createAndSavePerson = done => {
  const richardBrewer = new Person({name: "Richard Brewer", age: 43, favoriteFoods: ["steak", "hamburgers", "cake"]}) 
  
  richardBrewer.save((err, data) => {
    if (err)
...
const arrayOfPeople = [
  {name: "Kevin Harris", age: 47, favoriteFoods: ["Pizza"]},
  {name: "Dave Horne", age: 45, favoriteFoods: ["Pork Chop", "Chicken"]},
  {name: "John Evans", age: 49, favoriteFoods: ["Pizza", "Mexican"]},
  {name: "Artice", age: 41, favoriteFoods: ["Anything"]}
]
...
const findEditThenSave = (personId, done) => {
  ...
  Person.findById(personId, (err, data) => {
    ...
    data.save((err, data) => done(null, data))
  })
}
